...
const billingFeatures = [
  {
    ...
    description:
      "Client companies के लिए structured manpower billing और invoice workflow.",
  },
  {
    title: "Payment Tracking",
    hindi: "भुगतान ट्रैकिंग",
    description:
      "Paid, pending और outstanding amounts को व्यवस्थित तरीके से track करने की foundation.",
  },
  {
    title: "Worker Earnings",
    hindi: "वर्कर कमाई",
    description:
      "Worker के working days, earnings, paid amount और pending amount को billing system से जोड़ने की व्यवस्था.",
  },
  {
    title: "Transaction History",
    hindi: "लेन-देन इतिहास",
    description:
      "हर payment और billing activity के लिए future-ready transaction record.",
  },
];
    ...
    <main>
      ...
      >
        ...
        >
          ...
          >
            Client billing, worker earnings, payments और transaction records
            को एक professional management system में व्यवस्थित करने की
            foundation.
          </p>
        </div>
      </section>
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              overflow: "hidden",
              background: "#fff",
              boxShadow: "0 24px 60px rgba(5,15,29,0.10)",
            }}
          >
            <div
              style={{
            ...
            <div style={{ padding: 24 }}>
              ...
              <div style={{ paddingTop: 20 }}>
                {[
                  ...
                  >
                    ...
                    <strong style={{ color: "var(--mm-blue-900)" }}>
                      {amount}
                    </strong>
                  </div>
                ))}
              ...
              <div
                style={{
                  ...
                  marginTop: 20,
                  padding: "16px 0 0",
                  borderTop: "2px solid var(--mm-blue-900)",
                }}
              >
                <strong style={{ color: "var(--mm-blue-900)" }}>
                  TOTAL
          ...
          <div>
            ...
            >
              Professional billing from one place.
            </h2>
            ...
            >
              आगे चलकर इसी system में client selection, worker deployment,
              attendance, service charges, invoice generation, payment
              recording और PDF invoice जैसे features जोड़े जा सकते हैं।
            </p>
      ...
      >
        <div className="mm-container">
          ...
          >
            ...
            >
              Attendance → Billing → Payment → History
            </h2>
      ...
      >
        ...
        >
          ...
          >
            Billing और invoice related information के लिए MUKESH MANPOWER
            team से संपर्क करें।
          </p>
