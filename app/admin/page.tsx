...
const stats = [
  ...
  },
  {
    ...
    hindi: "सक्रिय वर्कर्स",
    icon: "👷",
  },
  {
    value: "06",
    label: "Client Companies",
    hindi: "क्लाइंट कंपनियां",
    icon: "🏢",
  },
  {
    value: "03",
...
const modules = [
  {
    ...
    hindi: "जॉब आवेदन",
    description: "नए candidates और applications को manage करें।",
  ...
  },
  {
    ...
    icon: "👷",
    title: "Workers",
    hindi: "वर्कर मैनेजमेंट",
    description: "Worker profiles, status और employment records manage करें।",
  ...
  },
  {
    ...
    title: "Attendance",
    hindi: "उपस्थिति",
    description: "Daily attendance और duty tracking के लिए central section.",
  ...
  },
  {
    ...
    icon: "🏢",
    title: "Companies",
    hindi: "क्लाइंट मैनेजमेंट",
    description: "Client companies और manpower requirements manage करें।",
  ...
  },
  {
    ...
    hindi: "बिलिंग और भुगतान",
    description: "Invoices, payments और financial records के लिए foundation.",
    action: "Open Billing",
  },
  {
    href: "/id-cards",
    ...
    hindi: "वर्कर आईडी कार्ड",
    description: "Approved workers के digital identification workflow को manage करें।",
    action: "Manage ID Cards",
  },
];
...
const activity = [
  {
    ...
    description: "एक नया candidate application submit हुआ।",
    time: "Today",
    type: "Application",
  },
  {
    title: "Worker approval required",
    description: "एक worker profile management approval का इंतजार कर रही है।",
    time: "Today",
    type: "Approval",
  },
  {
    title: "Attendance record pending",
    description: "आज का attendance record update करना बाकी है।",
    time: "Today",
    type: "Attendance",
  },
];
    ...
    <main className="mm-admin-page">
      ...
      <header className="mm-admin-header">
        <div className="mm-container mm-admin-header-inner">
          ...
          <div className="mm-admin-header-actions">
            <span className="mm-admin-status">
              <i />
              System Online
            </span>
        ...
        <div className="mm-container">
          <div className="mm-admin-hero-content">
            <div>
              ...
              <p>
                आपकी manpower operations, workers, applications, attendance,
                companies और billing को एक central management system में
                organize करने की foundation.
              </p>
            </div>
      ...
      <section className="mm-admin-modules-section">
        <div className="mm-container">
          <div className="mm-admin-section-heading">
            ...
            <p>
              हर operational section के लिए dedicated management module.
            </p>
          </div>
        ...
        <div className="mm-container mm-admin-operations-grid">
          ...
          <div className="mm-admin-panel">
            <div className="mm-panel-heading">
              <div>
                <span className="mm-admin-section-label">
                  QUICK OPERATIONS
                </span>
        ...
        <div className="mm-container">
          <div className="mm-future-dashboard">
            <div>
              ...
              <p>
                यह dashboard आगे चलकर secure login, real database, owner
                approval, worker records, attendance, salary, advances,
                invoices, notifications और ID verification system से connect
                किया जाएगा।
              </p>
            </div>
      ...
      <style>{`
        ...
        .mm-admin-status i {
          ...
          border-radius: 50%;
          background: #28a76a;
          box-shadow: 0 0 0 4px rgba(40,167,106,0.10);
        }
        ...
        .mm-admin-owner-card strong {
          display: block;
          margin-top: 8px;
          font-size: 19px;
        }

        .mm-admin-owner-card small {
          display: block;
          margin-top: 5px;
          color: #bdccda;
          font-size: 11px;
        ...
        .mm-admin-stat-card {
          ...
          border-radius: 20px;
          background: #fff;
          box-shadow: 0 14px 45px rgba(5,15,29,0.08);
        }
        ...
        .mm-admin-stat-card h3 {
          margin: 8px 0 0;
          color: var(--mm-blue-900);
          font-size: 14px;
        }

        .mm-admin-stat-card p {
          margin: 3px 0 0;
          color: var(--mm-muted);
          font-size: 11px;
        }

        .mm-admin-modules-section {
          padding: 55px 0 80px;
          background: var(--mm-surface);
        }

        .mm-admin-section-heading {
          display: flex;
          justify-content: space-between;
        ...
        .mm-admin-section-heading p {
          margin: 0;
          color: var(--mm-muted);
          font-size: 13px;
        }

        .mm-admin-module-grid {
          display: grid;
          grid-template-columns: repeat(3, minmax(0, 1fr));
          gap: 18px;
        }

        .mm-admin-module-card {
          padding: 25px;
          border: 1px solid var(--mm-border);
          border-radius: 20px;
          background: #fff;
          box-shadow: 0 7px 28px rgba(5,15,29,0.04);
          transition: transform 0.2s ease, box-shadow 0.2s ease;
        }

        .mm-admin-module-card:hover {
        ...
        .mm-admin-operations-section {
          padding: 0 0 80px;
          background: var(--mm-surface);
        }

        .mm-admin-operations-grid {
          display: grid;
        ...
        .mm-quick-action strong {
          display: block;
          color: var(--mm-blue-900);
          font-size: 13px;
        }

        .mm-quick-action small {
          display: block;
          margin-top: 3px;
          color: var(--mm-muted);
          font-size: 10px;
