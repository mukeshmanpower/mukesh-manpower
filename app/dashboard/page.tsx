...
const modules = [
  {
    ...
    hindi: "आवेदन प्रबंधन",
    description: "नए candidates, application status और approval workflow manage करें।",
    href: "/apply",
    icon: "📝",
  },
  {
    title: "Workers",
    hindi: "वर्कर प्रबंधन",
    description: "Worker profiles, deployment, earnings और employment records देखें।",
    href: "/workers",
    icon: "👷",
  },
  {
    title: "Attendance",
    hindi: "उपस्थिति प्रबंधन",
    description: "Daily attendance, working days और duty records manage करें।",
    href: "/attendance",
    icon: "📊",
  },
  {
    title: "Client Companies",
    hindi: "क्लाइंट प्रबंधन",
    description: "Companies, manpower requirements और client information manage करें।",
    href: "/companies",
    icon: "🏢",
  },
  {
    title: "Billing",
    hindi: "बिलिंग एवं भुगतान",
    description: "Invoices, paid amounts, pending payments और transactions track करें।",
    href: "/billing",
    icon: "🧾",
  },
  {
    ...
    hindi: "पहचान पत्र",
    description: "Approved workers के लिए verification और digital ID workflow manage करें।",
    href: "/id-cards",
    icon: "🪪",
  },
];
        ...
        <div className="mm-container">
          ...
          >
            <div>
              ...
              >
                एक central management interface जहाँ से applications,
                workers, attendance, companies, billing और ID cards को एक
                structured workflow में manage किया जा सके।
              </p>
            </div>
      ...
      >
        <div className="mm-container">
          <div style={{ marginBottom: 30 }}>
            ...
            >
              Everything in one control center
            </h2>
          </div>
      ...
      >
        <div className="mm-container">
          <div style={{ marginBottom: 30 }}>
            ...
            >
              यही workflow आगे चलकर real database, authentication और
              management actions से connect किया जाएगा।
            </p>
          </div>
